...
MODEL_PATH = r"C:/Users/Fadhil Muhammad/.lmstudio/models/lmstudio-community/Qwen3-4B-GGUF/Qwen3-4B-Q4_K_M.gguf"
...
Remember: You are {character} defending "{lie}" - make it believable!"""
    ...
    def get_defensive_dialogue(self, player_rebuttal):
        context_prompt = f"The player challenges you with: '{player_rebuttal}'\n\nRemember, you are {self.character_name} defending that {self.character_lie}. Respond defensively but intelligently."
        
        self.messages.append({"role": "user", "content": context_prompt})
        npc_response = self._generate_streamed_response()
        self.messages.append({"role": "assistant", "content": npc_response})
        return npc_response
...
Respond with ONLY one word: "PLAYER" or "NPC" with the quotation marks"""
        ...
        # tambahin conversation history buat context
    ...
    def play_scenario(self, scenario):
        ...
        for i in range(rounds):
            ...
            while selected_fact is None and search_attempts < max_searches:
                ...
                used_searches.append(search_query)
                
                if not search_results:
                    print(f"No relevant information found for '{search_query}'.")
                ...
                if choice == 'quit' or choice == 'q':
                    ...
                    try:
                        ...
                        if 0 <= fact_idx < len(search_results):
                            selected_fact = search_results[fact_idx]['content']
                            ...
                            if search_attempts < max_searches:
                                ...
                                selected_fact = search_results[0]['content'] if search_results else "Some unclear information"
                    except ValueError:
                        print("Invalid input!")
                        if search_attempts < max_searches:
                            continue
